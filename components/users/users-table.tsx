  ...
  const columns: ColumnDef<any>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Badge
            className={tariff === "Premium" ? "bg-red-500" : tariff === "Standard" ? "bg-green-500" : "bg-gray-500"}
          >
            {tariff}
          </Badge>
        )
    ...
    <div>
      <div className="flex flex-col md:flex-row gap-4 mb-4">
        ...
        <div className="flex gap-2">
          ...
          <Select value={tariffFilter || ""} onValueChange={(value) => setTariffFilter(value || null)}>
            <SelectTrigger className="w-[180px]">
              <SelectValue placeholder={t("filterByTariff")} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="all">{t("all")}</SelectItem>
